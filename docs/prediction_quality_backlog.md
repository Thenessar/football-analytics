...
| FA-108 | P6 — Per-player NB dispersion in sim allocation (passes coverage fix) | Croupier | FA-106 (evidence) | 🟨 VALIDATION SPLIT (2026-07-12) — coverage gate met (0.710), PIT gate missed (0.139 > ~0.08); default stays off, control arm pending |
